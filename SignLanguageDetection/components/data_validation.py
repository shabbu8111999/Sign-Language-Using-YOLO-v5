...
from SignLanguageDetection.entity.config_entity import DataValidationConfig
from SignLanguageDetection.entity.artifacts_entity import (DataIngestionArtifact, DataValidationArtifact)
